...
/***/ function(module, exports, __webpack_require__) {
	...
	var _history = __webpack_require__(279);

	var _reduxSimpleRouter = __webpack_require__(234);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// includes the main scss file

	var history = (0, _history.createHistory)();

	(0, _reduxSimpleRouter.syncReduxAndRouter)(history, _store2.default);
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			_reactRouter.Router,
			{ history: history, store: _store2.default },
			_routes2.default
		)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js?includePaths[]=/Users/alecrobins/Documents/Projects/ProjectHunt/node_modules/compass-mixins/lib!./screen.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js?includePaths[]=/Users/alecrobins/Documents/Projects/ProjectHunt/node_modules/compass-mixins/lib!./screen.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extractPath = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createElement(
		...
		_react2.default.createElement(_reactRouter.Route, { path: 'profile/edit', component: _ProfileEdit2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'createPost', component: _Form2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postActions = __webpack_require__(238);
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					postData.map(function (item, index) {
						return _react2.default.createElement(
							'div',
							{ key: item._id, className: 'post-container--outer' },
							_react2.default.createElement(_Post2.default, _extends({ likePost: function likePost() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapValues = __webpack_require__(227);

	var _mapValues2 = _interopRequireDefault(_mapValues);

	var _pick = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postConstants = __webpack_require__(256);

	var types = _interopRequireWildcard(_postConstants);
		...
		_createClass(Post, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_PostSocial2.default, this.props),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'h2',
							{ className: 'h2__tagline' },
							this.props.tag_line
						),
						_react2.default.createElement(
							'div',
							{ className: 'post-content__author' },
							_react2.default.createElement('img', { src: this.props.post_author.photo_url, alt: 'Profile picture', className: 'profile' }),
							_react2.default.createElement(
								'h4',
								{ className: 'h4' },
								this.props.post_author.name
							),
							_react2.default.createElement(_Talent2.default, { talent: 'Biz Dev', color: '#00D5FF' })
						),
						_react2.default.createElement(
							'p',
							{ className: 'p__main' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = (_dec = (0, _reactRedux.connect)(function (state) {
		...
		_createClass(Main, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				this.props.dispatch((0, _authed.initAuthed)());
			}
		}, {
			key: 'render',
			value: function render() {
	...
	var NavBar = (_dec = (0, _reactRedux.connect)(function (state) {
		...
		_createClass(NavBar, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'nav-container--inner -clear' },
					_react2.default.createElement('img', {
						src: 'assets/imgs/logo.png',
						alt: 'Project Hunt Logo',
						className: 'nav-logo',
						onClick: function onClick() {
							return _this2.props.dispatch((0, _reduxSimpleRouter.pushPath)('/'));
						} }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		return _react2.default.createElement("input", { type: "text", placeholder: "search all the posts", className: "nav-searchbar" });
	};
		...
		_createClass(NavBarUser, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('img', { src: this.props.user.userData.photo_url, alt: 'Profile picture' }),
					...
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
								return _this2.props.dispatch((0, _reduxSimpleRouter.pushPath)('/createPost'));
							} },
						'Creat Post'
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function initAuthed() {
	  return {
	    type: types.GET_USER,
	    promise: _axios2.default.get(_config.backend_url + '/api/user')
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// user: state.user,
	var ProfileEdit = (_dec = (0, _reactRedux.connect)(function (state) {
		return {};
	}), _dec(_class = (function (_React$Component) {
		...
		function ProfileEdit() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(ProfileEdit).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = (_dec = (0, _reactRedux.connect)(function (state) {
		return {
			user: state.user
		};
	}), _dec(_class = (function (_React$Component) {
		...
		_createClass(Form, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'label',
						{ htmlFor: 'talentNeeded' },
						'Talent Needed'
					),
					_react2.default.createElement('input', { type: 'text', name: 'talentNeeded', ref: function ref(c) {
							return _this2._talentNeeded = c;
						} }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'label',
					...
					_react2.default.createElement('input', { type: 'text', name: 'tags', ref: function ref(c) {
							return _this2._tags = c;
						} }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'label',
					...
					_react2.default.createElement('input', { type: 'file', name: 'imgs', ref: function ref(c) {
							return _this2._imgs = c;
						} }),
					_react2.default.createElement(
						'button',
						{ onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _promiseMiddleware = __webpack_require__(274);

	var _promiseMiddleware2 = _interopRequireDefault(_promiseMiddleware);

	var _reduxSimpleRouter = __webpack_require__(234);

	var _reducerTest = __webpack_require__(275);

	var _reducerTest2 = _interopRequireDefault(_reducerTest);

	var _incrementTest = __webpack_require__(276);

	var _incrementTest2 = _interopRequireDefault(_incrementTest);

	var _postReducer = __webpack_require__(277);

	var _postReducer2 = _interopRequireDefault(_postReducer);

	var _authReducer = __webpack_require__(278);
	...
	var reducer = (0, _redux.combineReducers)({
	    messages: _reducerTest2.default,
	    count: _incrementTest2.default,
	    routing: _reduxSimpleRouter.routeReducer, // keep track of routing
	...
	function reducer_1() {
		...
		switch (action.type) {
			case 'SAY_SOMETHING':
				...
				return _extends({}, state, { // return all of the previous state
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createHashHistory2 = __webpack_require__(166);
	...
	var _useBeforeUnload2 = __webpack_require__(281);
	...
	var _enableBeforeUnload2 = __webpack_require__(282);

	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);

	exports.enableBeforeUnload = _enableBeforeUnload3['default'];

	var _enableQueries2 = __webpack_require__(283);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload = __webpack_require__(281);
